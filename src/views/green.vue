        ...
        <nav class="navbar navbar-expand-lg bg-white sticky-top border-bottom py-3">
            <div class="container">
                <a class="navbar-brand navbar-brand-custom" href="#">
                    Angkor<span class="dot">Stay</span>
                </a>
            ...
            <div class="container">
                ...
                <div class="row g-4 text-start">
                    ...
                    <div class="col-md-4 feature-item">
                        ...
                        <h6>Book direct, pay less</h6>

                        <p>
                            No third-party markup — the price you see
                            is what the hotel actually charges.
                        </p>
                    </div>
                    ...
                    <div class="col-md-4 feature-item">
                        ...
                        <p>
                            Most rooms can be cancelled up to 24 hours
                            before check-in at no cost.
                        </p>
                    </div>
                    ...
                    <div class="col-md-4 feature-item">
                        ...
                        <p>
                            A Phnom Penh-based team who answers in
                            minutes, not days.
                        </p>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="desc">
                            Independent stays across Cambodia —
                            from riverfront heritage hotels to
                            cliffside villas — booked directly.
                        </p>
                    </div>
                    ...
                    <div class="col-lg-2">
                        ...
                        <h6>Get travel deals</h6>

                        <p class="desc mb-2">
                            One email a month, mostly discount codes.
                        </p>

                        <input
                            type="email"
                            class="form-control form-control-sm newsletter-input"
                            placeholder="you@example.com"
                        >

                        <button
                            class="btn btn-primary-brand btn-sm mt-2"
                        >
                            Subscribe
                        </button>
                ...
                <div
                    class="footer-bottom d-flex flex-wrap justify-content-between"
                >
                    <span>
                        © 2026 AngkorStay. Customer portal.
                    </span>
...
const reviews = ref([
    {
        name: 'Sophea K.',
        location: 'Phnom Penh',
        text: 'Booked a riverside room the same day I searched — check-in was seamless.'
    },
    {
        name: 'Daniel R.',
        location: 'Siem Reap',
        text: 'The temple-view rooftop pool alone was worth the trip out to Siem Reap.'
    },
    {
        name: 'Chantha V.',
        location: 'Kampot',
        text: 'The lodge arranged a sunset boat cruise I never would have found on my own.'
    }
])
</script>
<style scoped>
